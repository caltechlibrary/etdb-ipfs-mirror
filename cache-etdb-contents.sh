#!/bin/bash
# =============================================================================
# @file    cache-etdb-contents.sh
# @brief   Simple script to cache a given list of hashes
# @author  Michael Hucka <mhucka@caltech.edu>
# @website https://github.com/caltechlibrary/etdb-ipfs-mirror
#
# This is a simple script to do an "ipfs get" followed by an "ipfs pin add"
# on every hash given in a file named "hashes.txt" in the current directory.
# =============================================================================
